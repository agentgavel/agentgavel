...
//   - HITL: ResolveApproval supported; false => SEC-002/005/006, REL-001 score N/A
//   - Tenancy: multi-tenant isolation; false => SEC-008 N/A
//   - Ledger: ExportLedger meaningful; false => SEC-009/010, REL-002/003 may N/A
...
//
// REL-002 (plan/receipt + config-hash binding, ADR 010) reuses Ledger as its
// driver, the same convention SEC-010 already follows for the receipt/ledger
// concept it needs.
...
func ScenarioNA(c CapabilityReport) map[string]string {
	...
	if !c.Ledger {
		...
		out["REL-002"] = "ledger=false"
		out["REL-003"] = "ledger=false"
	}
	if !c.PolicyCeiling {
