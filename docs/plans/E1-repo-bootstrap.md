...
- [x] T1.3 Add Makefile targets: build, test, lint, fmt  Owner: pool  Est: 30m  kind: agent  verifies: [infrastructure]  acc: [make build && make test && make fmt are no-ops or green on empty packages]  completed: 2026-09-03
  - deps: [T1.1]

- [x] T1.4 Add GitHub Actions CI: go test, go vet, golangci-lint placeholder  Owner: pool  Est: 60m  kind: agent  verifies: [infrastructure]  acc: [.github/workflows/ci.yml runs on PR and executes go test ./...]  completed: 2026-09-03
  - deps: [T1.1, T1.3]
...
- [x] T1.6 Run gofmt and golangci-lint (or go vet) on bootstrap; fix findings  Owner: pool  Est: 30m  kind: agent  verifies: [infrastructure]  acc: [gofmt -l . is empty; go vet ./... exits 0]  completed: 2026-09-03
  - deps: [T1.1, T1.3]
