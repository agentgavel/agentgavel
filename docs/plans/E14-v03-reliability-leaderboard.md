...
- [x] T14.15 Full make test && make lint on clean tree after E14 landings  Owner: pool  Est: 45m  kind: agent  verifies: [infrastructure]  acc: [make test and make lint exit 0 and bash scripts/check-dashboard.sh exits 0 on main]  deps: [T14.14, T14.8, T14.12, T14.13, T14.21, T14.22, T14.23]  completed: 2026-09-05
