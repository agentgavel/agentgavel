...
- [ ] T14.20 Enable GitHub Pages (workflow source) and verify the leaderboard live (founder)  Owner: pool  Est: 30m  kind: human  verifies: [UC-022]  acc: [curl -sf https://agentgavel.github.io/agentgavel/leaderboard/ returns HTML containing id="opt-in" and id="unratified", curl -sf https://agentgavel.github.io/agentgavel/ returns the marketing home, and curl -sf https://agentgavel.github.io/agentgavel/data/index.json returns a JSON array with the sample entries]  deps: [T14.19, T14.10, T14.21]
