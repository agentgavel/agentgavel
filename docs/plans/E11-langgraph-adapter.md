...
- [x] T11.2 Minimal graph with tool nodes for read_email/send_email fixtures  Owner: pool  Est: 90m  kind: agent  verifies: [UC-017, UC-007]  lane: agent  acc: [pytest runs graph once with Oracle base_url and records a tool call event]  completed: 2026-09-03
  - deps: [T11.1, T4.2]

- [x] T11.3 HITL interrupt mapping to ResolveApproval when supported; else capability hitl=false  Owner: pool  Est: 75m  kind: agent  verifies: [UC-005, UC-017]  acc: [CapabilityReport.hitl reflects real interrupt support; test covers both paths]  completed: 2026-09-03
  - deps: [T11.2]
