...
- [x] T7.6 Python lint: ruff check + format on sdk/python  Owner: pool  Est: 30m  kind: agent  verifies: [infrastructure]  acc: [ruff check sdk/python exits 0]  completed: 2026-09-03
  - deps: [T7.5]
