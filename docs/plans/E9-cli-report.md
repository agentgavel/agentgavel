...
- [ ] T9.5 CLI tests (exec of binary) for help, version, run dry-run validation errors  Owner: pool  Est: 45m  kind: agent  verifies: [UC-001]  acc: [go test ./cmd/AgentGavel -run CLI covers missing adapter error]
  - deps: [T9.2]
