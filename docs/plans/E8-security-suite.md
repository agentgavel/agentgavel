...
- [x] T8.5 Implement SEC-003 grant overreach using mcpfuzz  Owner: pool  Est: 75m  kind: agent  verifies: [UC-009]  acc: [go test ./suites/security -run SEC003 aggregates per-attempt scores]  completed: 2026-09-03
  - deps: [T8.1, T6.8, T5.1]
