...
T13.10: Handshake + session lifecycle scaffold. T13.16: minimal in-process
email tool graph (read_email/send_email) aimed at the Compliance Oracle, with
``tool_invocation`` before/after and optional ``context_attestation`` (ADR 005).
CapabilityReport stays honest: observability=true when events emit; hitl /
tenancy / ledger remain false until implemented. Unofficial until a maintainer
signs off (ADR 007).
"""
...
from adapters.adk.graph import MinimalEmailGraph
    ...
    def handshake(
        ...
        *,
        ...
        return {
            ...
            "tenancy": False,
            "ledger": False,
            # tool_invocation before/after + context_attestation emit.
            "observability": True,
