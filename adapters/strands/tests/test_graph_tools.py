"""T13.20: minimal email graph runs once against an Oracle base_url."""
...
from adapters.strands.graph import (
    TOOL_READ_EMAIL,
    TOOL_SEND_EMAIL,
    MinimalEmailGraph,
    tool_nodes,
...
def test_adapter_submit_task_emits_via_capture(oracle_base_url: str) -> None:
    ...
    assert adapter.handshake("1.0")["observability"] is True
